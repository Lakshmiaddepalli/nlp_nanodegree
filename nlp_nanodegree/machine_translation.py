...
def tokenize(x):
    ...
    # TODO: Implement
    #print(t)
    #print(text_to_word_sequence(x))
    #print(t.texts_to_sequences(x))
...
print("length is:", len(preproc_english_sentences))
...
def logits_to_text(logits, tokenizer):
    ...
    for keys,values in index_to_words.items():
...
def simple_model(input_shape, output_sequence_length, english_vocab_size, french_vocab_size):
    ...
    predictions = Dense(french_vocab_size, activation='softmax')(a)
...
print("shape of english sentences after reshaping is",tmp_x.shape)
print(tmp_x)
...
def embed_model(input_shape, output_sequence_length, english_vocab_size, french_vocab_size):
    ...
    print(input_shape[-1:])
    a = Input(input_shape[1:])
    first_layer = Embedding(english_vocab_size,100,input_length=output_sequence_length)(a)
    predictions = Dense(french_vocab_size, activation='sigmoid')(first_layer)
    model = Model(inputs=a, outputs=predictions)
    learning_rate = 0.02
    model.compile(loss=sparse_categorical_crossentropy,
                  optimizer=Adam(learning_rate),
